      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          if(data['is_repeat'] == 1){
            ...
            addChatData(data['id'],data['next_question']['question'], data['next_question']['answer'],data['next_options_html']);
           

          }
          // if(data['is_last_question'] == 1){
          //   RepeatAppendChatHtml();
          //   addChatData(data['id'],data['next_question'], data['next_question']['answer'],data['next_options_html']);
...
`);
  ...
  function addChatData(id,question="",answer="",options_html=""){
    new_count = parseInt(qt_count) + 1
          ...
          contant = '<h6 class="text-center" id="chat_question">' + question + '</h6>' + '<b>' + answer + '</b>' + options_html;
