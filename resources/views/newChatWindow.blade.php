...
<body data-theme="indigo">
    ...
    <div class="app-container">
      ...
      <div class="chat-list-wrapper">
        ...
        <div class="app-main">
            <input id="is_repeat" type="hidden" value="0">
                ...
                <div class="message-wrapper">
                    ...
                    <div class="message-box-wrapper">
                        <div id="bot-question" class="message-box">
                            ...
                            <br><a class="btn btn-primary btn-sm" href="https://www.linkedin.com/in/arjunsvarma/"
                                target="_blank">
        ...
        <div class="app-right">
            <div class="app-profile-box">
                <img src="https://images.unsplash.com/photo-1587080266227-677cc2a4e76e?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80"
                    alt="profile">
                <p class="app-profile-box-title name"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round" class="feather feather-user">
                        <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                        <circle cx="12" cy="7" r="4" />
                    </svg>{{ ucwords(Auth::user()->name) }}</p>
                <p class="app-profile-box-title mail"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            ...
            $.ajax({
                ...
                success: function(data) {
                  if(data['is_last_question'] == 1){
                    ...
                    if (data['is_repeat'] == 1) {
                        nextQuestionArray = Array.from(data['next_question']);

                        RepeatAppendChatHtml();
...
`);
        ...
        function addChatData(id, question, answer, options_html) {
            ...
            contant = '<h6 class="text-center">' + question + '</h6>' + '<b>' + answer + '</b>' + options_html;
