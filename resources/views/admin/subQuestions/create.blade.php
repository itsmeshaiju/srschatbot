...
<div class="col-md-12">
  ...
  <div class="card card-primary">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    {!! Form::open(array('route' => 'subquestion.store','method'=>'POST')) !!}
    <div class="card-body">
          ...
          <div class="multi-field-wrapper col-md-12 mt-4">
            ...
            <div class="multi-fields">
              <div class="multi-field1">
                ...
                <div class="col-md-12 row multi-field">
                  <div class="col-md-3">
                  <input id="filter_question" placeholder="Sub Question" required="" class="form-control mt-2" name="question[]" type="text" value="" required>
                  </div>
                  <div class="col-md-3">
                    <input id="filter_question" placeholder="Answer" required="" class="form-control mt-2" name="answer[]" type="text" value="" required>
                    </div>
                    <div class="col-md-3">
