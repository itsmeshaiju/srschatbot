              ...
              <ul>
                  <li>
                      ...
                      <ul>
                          ...
                          <li>
                              <label for="">Stylus <br> test</label>
                          </li>
                      </ul>
                  </li>
                  <li>
                      ...
                      <ul>
                              ...
                              <ul>
                                  ...
                                  <li>
                                    <input type="checkbox" id="nextJS">
                                      ...
                                      <ul>
                                        <li>
                                            <label for="">nextjs 1</label>
                                        </li>
                                        <li>
                                            <label for="">next js2</label>
                                        </li>
                                    </ul>
                                  </li>
                              </ul>
                          ...
                          <li>
                            <input type="checkbox" id="vue">
                              ...
                              <ul>
                                <li>
                                    <label for="">vue1</label>
                                </li>
                                <li>
                                    <label for="">vue2</label>
                                </li>
                            </ul>
                          </li>
                          <li>
...
<script>
    document.getElementById('range').addEventListener('input', function(){
      document.querySelector('.container').style.fontSize = this.value + 'px';
  });
  </script>
  @endsection
