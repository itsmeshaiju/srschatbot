        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="col-xs-12 col-sm-12 col-md-12 row">
                    ...
                    <div class="form-group col-md-4">
                        <strong>Role </strong>
                        <select id="filter_role" class="form-control select2 select2-hidden-accessible" name="role"
                            style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                            <option selected="selected" value="">-- Select --</option>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                @can($permission . '-create')
                    <div class="ml-auto">
                        <a class="btn btn-success btn-sm" href="{{ route('users.create') }}">Create New {{ $page_name }}</a>
                    </div>
                @endcan
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped  user_tbl">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Name</th>
